const config = {
  ...
  description: {
    ...
    FR: {
      short: `Baptiste Gaillard est doctorant en sociologie depuis décembre 2021 au Laboratoire Interdisciplinaire Sciences Innovations Sociétés (UMR INRAE/LISIS)<a href="https://umr-lisis.fr/">ici</a>, et il est cofinancé par le projet de recherche ANR-19-MGPA-0010 WAYS-OUT.`,
      long: "", // Idem, ajout d'une description longue si nécessaire
    },
  },
  links: [
    {
  ...
  email: {
    name: "baptisteg.gaillard",
    domain: "politique.science",
  },
};
